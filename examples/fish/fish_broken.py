...
class _AbstractFish(turtle.Turtle):
    ...
    def move(self, step):
        """Moves this fish forwards by step pixels."""
        # I broke this
        pass
...
class NPCFish(_AbstractFish):
    ...
    def random_move(self):
        """Randomly change heading and move forward according to speed."""
        direction_change = random.randint(-20, 20)
        # Missing something here:
        # Turn the fish

        # Make it move (use self.get_speed())
